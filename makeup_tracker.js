...
shades = [
    ...
    new Shade("Natasha Denona", "Bronze", "Suntan", "terracotta", "matte", "photos/nd-bronze/suntan.jpg"),
    ...
    new Shade("Natasha Denona", "Bronze", "Ridge", "tan", "matte", "photos/nd-bronze/ridge.jpg"),
    ...
    // Lime Crime Venus XL
    new Shade("Lime Crime", "Venus XL", "Eden", "pink", "shimmer", "photos/lc-venus-xl/eden.jpg"),
    new Shade("Lime Crime", "Venus XL", "Love", "bronze", "shimmer", "photos/lc-venus-xl/love.jpg"),
    ...
    new Shade("Jeffree Star", "Jawbreaker", "Virgin", "white", "matte", "photos/js-jawbreaker/virgin.jpg"),
    new Shade("Jeffree Star", "Jawbreaker", "Good Morning", "beige", "matte", "photos/js-jawbreaker/good-morning.jpg"),
    new Shade("Jeffree Star", "Jawbreaker", "Bubble Gum", "pink", "matte", "photos/js-jawbreaker/bubble-gum.jpg"),
    new Shade("Jeffree Star", "Jawbreaker", "Wow", "yellow", "matte", "photos/js-jawbreaker/wow.jpg"),
    new Shade("Jeffree Star", "Jawbreaker", "Suck", "orange", "matte", "photos/js-jawbreaker/suck.jpg"),
    new Shade("Jeffree Star", "Jawbreaker", "Licorice", "red", "matte", "photos/js-jawbreaker/licorice.jpg"),
    new Shade("Jeffree Star", "Jawbreaker", "Cute", "mint", "matte", "photos/js-jawbreaker/cute.jpg"),
    new Shade("Jeffree Star", "Jawbreaker", "Fuck", "orange", "matte", "photos/js-jawbreaker/fuck.jpg"),
    new Shade("Jeffree Star", "Jawbreaker", "Gum Drop", "purple", "matte", "photos/js-jawbreaker/gum-drop.jpg"),
    new Shade("Jeffree Star", "Jawbreaker", "Snack", "rose gold", "shimmer", "photos/js-jawbreaker/snack.jpg"),
    new Shade("Jeffree Star", "Jawbreaker", "Brain Freeze", "blue", "matte", "photos/js-jawbreaker/brain-freeze.jpg"),
    new Shade("Jeffree Star", "Jawbreaker", "Jawbreaker", "white", "metallic", "photos/js-jawbreaker/jawbreaker.jpg"),
    new Shade("Jeffree Star", "Jawbreaker", "And What?", "red", "metallic", "photos/js-jawbreaker/and-what.jpg"),
    new Shade("Jeffree Star", "Jawbreaker", "Orange Juice", "orange", "metallic", "photos/js-jawbreaker/orange-juice.jpg"),
    new Shade("Jeffree Star", "Jawbreaker", "Sour", "green", "matte", "photos/js-jawbreaker/sour.jpg"),
    new Shade("Jeffree Star", "Jawbreaker", "Soaked", "blue", "matte", "photos/js-jawbreaker/soaked.jpg"),
    new Shade("Jeffree Star", "Jawbreaker", "Raspberry", "red", "matte", "photos/js-jawbreaker/raspberry.jpg"),
    new Shade("Jeffree Star", "Jawbreaker", "Cotton Candy", "pink", "metallic", "photos/js-jawbreaker/cotton-candy.jpg"),
    new Shade("Jeffree Star", "Jawbreaker", "Lemon Drop", "yellow", "metallic", "photos/js-jawbreaker/lemon-drop.jpg"),
    new Shade("Jeffree Star", "Jawbreaker", "Bite Me", "purple", "metallic", "photos/js-jawbreaker/bite-me.jpg"),
    new Shade("Jeffree Star", "Jawbreaker", "Cherry Wet", "red", "matte", "photos/js-jawbreaker/cherry-wet.jpg"),
    new Shade("Jeffree Star", "Jawbreaker", "Tasty", "brown", "matte", "photos/js-jawbreaker/tasty.jpg"),
    new Shade("Jeffree Star", "Jawbreaker", "Cone", "tan", "matte", "photos/js-jawbreaker/cone.jpg"),
    new Shade("Jeffree Star", "Jawbreaker", "Delicious", "navy", "matte", "photos/js-jawbreaker/delicious.jpg"),

    // Viseart Neutral Mattes
    new Shade("Viseart Paris", "Neutral Mattes", "Cannelle", "peach", "matte", "photos/vs-neutral-mattes/cannelle.jpg"),
